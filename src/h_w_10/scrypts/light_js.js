...
export function clickCounterJs() {
    ...
    const lightsRed = lights.querySelector('.content_show__red_js');
    const lightsYellow = lights.querySelector('.content_show__yellow_js');
    const lightsGreen = lights.querySelector('.content_show__green_js');
